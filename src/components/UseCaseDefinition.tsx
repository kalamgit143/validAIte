...
import { FileText, Target, Users, AlertTriangle, CheckCircle, Plus, CreditCard as Edit, Eye, Download, Save, Brain, Shield, Globe, Heart, Building, Code, Lightbulb, Zap, Activity, Clock, BarChart3, Scale, Lock, Database, Settings, Award, Gavel, Crown, TestTube, FileCheck, Workflow, GitBranch, Timer, Layers, Search, Filter, XCircle, ArrowRight, ArrowDown, ArrowLeft, List, BookOpen, Briefcase } from 'lucide-react';
