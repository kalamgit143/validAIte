      ...
      <div className="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/10 dark:to-cyan-900/10 border-2 border-blue-200 dark:border-blue-800 rounded-xl p-5 flex items-start space-x-3 shadow-sm">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-blue-800 dark:text-blue-300">
            Fill in all sections to establish the foundation for your AI governance workflow. This information will be used throughout the validation pipeline to generate risk profiles, metrics, and TEVV packs.
          </p>
        </div>
      </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                    ...
                    {sectionNum === 5 && 'Review finalized profile and proceed to next stage'}
                  </p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                  ...
                  {sectionNum === 5 && (
                    <div className="space-y-6">
                          ...
                          <div className="space-y-3">
                            <div className="flex items-center space-x-3">
                              ...
                              <h3 className="text-3xl font-bold">
                                {applicationData.application_name || 'Application Profile'}
                              </h3>
                            </div>
                            <p className="text-blue-100 text-lg max-w-2xl">
                              {applicationData.application_description || 'No description provided'}
                            </p>
                            <div className="flex items-center space-x-3 pt-2">
                              <span className="px-4 py-2 bg-white/20 backdrop-blur-sm rounded-lg text-sm font-medium">
                                {applicationData.domain.toUpperCase()}
                              </span>
                              <span className="px-4 py-2 bg-white/20 backdrop-blur-sm rounded-lg text-sm font-medium flex items-center space-x-1">
                                <Server className="w-4 h-4" />
                                <span>{applicationData.deployment_environment.toUpperCase()}</span>
                              </span>
                              <span className={`px-4 py-2 backdrop-blur-sm rounded-lg text-sm font-bold ${
                                systemMetadata.status === 'submitted' || systemMetadata.status === 'approved'
                                  ? 'bg-green-500/30'
                                  : 'bg-yellow-500/30'
                              }`}>
                                {systemMetadata.status.toUpperCase()}
                              </span>
                            </div>
                          </div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="p-5 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl border-2 border-blue-200 dark:border-blue-700">
                          <div className="flex items-center justify-between mb-2">
                            <Users className="w-6 h-6 text-blue-600 dark:text-blue-400" />
                            <span className="text-2xl font-bold text-blue-600 dark:text-blue-400">{useCases.length}</span>
                          </div>
                          <div className="text-sm font-medium text-gray-700 dark:text-gray-300">Use Cases</div>
                        </div>

                        <div className="p-5 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl border-2 border-green-200 dark:border-green-700">
                          <div className="flex items-center justify-between mb-2">
                            <Upload className="w-6 h-6 text-green-600 dark:text-green-400" />
                            <span className="text-2xl font-bold text-green-600 dark:text-green-400">{uploadedFiles.length}</span>
                          </div>
                          <div className="text-sm font-medium text-gray-700 dark:text-gray-300">Files Uploaded</div>
                        </div>

                        <div className="p-5 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl border-2 border-purple-200 dark:border-purple-700">
                          <div className="flex items-center justify-between mb-2">
                            <Terminal className="w-6 h-6 text-purple-600 dark:text-purple-400" />
                            <span className="text-2xl font-bold text-purple-600 dark:text-purple-400">{technicalDetails.api_endpoints.length}</span>
                          </div>
                          <div className="text-sm font-medium text-gray-700 dark:text-gray-300">API Endpoints</div>
                        </div>

                        <div className="p-5 bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 rounded-xl border-2 border-orange-200 dark:border-orange-700">
                          <div className="flex items-center justify-between mb-2">
                            <TrendingUp className="w-6 h-6 text-orange-600 dark:text-orange-400" />
                            <span className="text-2xl font-bold text-orange-600 dark:text-orange-400">{completeness}%</span>
                          </div>
                      ...
                      <div className="bg-white dark:bg-gray-800 rounded-xl border-2 border-gray-200 dark:border-gray-700 p-6">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                          <div>
                            <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">LLM Provider</div>
                            <div className="font-bold text-gray-900 dark:text-white text-lg">{technicalDetails.llm_provider || 'Not set'}</div>
                          </div>
                          <div>
                            <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Model</div>
                            <div className="font-bold text-gray-900 dark:text-white text-lg">{technicalDetails.llm_model_name || 'Not set'}</div>
                          </div>
                          <div>
                            <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Interface</div>
                            <div className="font-bold text-gray-900 dark:text-white text-lg">{technicalDetails.interface_type.toUpperCase()}</div>
                          </div>
                          <div>
                            <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Vector DB</div>
                            <div className="font-bold text-gray-900 dark:text-white text-lg">{technicalDetails.vector_db || 'None'}</div>
                          </div>
                          <div>
                            <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Auth Method</div>
                            <div className="font-bold text-gray-900 dark:text-white text-lg">{technicalDetails.auth_method.toUpperCase()}</div>
                          </div>
                          <div>
                            <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Autonomy Level</div>
                            <div className="font-bold text-gray-900 dark:text-white text-lg">{applicationData.autonomy_level.replace('-', ' ')}</div>
                          </div>
                        </div>
                      </div>

                      {/* Modifiers & Features */}
                      {applicationData.modifiers.length > 0 && (
                        <div className="bg-white dark:bg-gray-800 rounded-xl border-2 border-gray-200 dark:border-gray-700 p-6">
                          <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center space-x-2">
                            <Zap className="w-5 h-5 text-cyan-600" />
                            <span>Modifiers & Features</span>
                          </h4>
                          <div className="flex flex-wrap gap-3">
                            {applicationData.modifiers.map(mod => (
                      ...
                      {/* System Metadata */}
                      <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 rounded-xl border-2 border-gray-200 dark:border-gray-600 p-6">
                        <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center space-x-2">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-sm">
                          <div>
                            ...
                            <div className="font-bold text-gray-900 dark:text-white">{systemMetadata.created_by}</div>
                          </div>
                          <div>
                            <div className="text-gray-500 dark:text-gray-400 mb-1">Created Date</div>
                            <div className="font-bold text-gray-900 dark:text-white">{new Date(systemMetadata.created_date).toLocaleDateString()}</div>
                          </div>
                          <div>
                            <div className="text-gray-500 dark:text-gray-400 mb-1">Tenant ID</div>
                            <div className="font-bold text-gray-900 dark:text-white font-mono">{systemMetadata.tenant_id}</div>
                          </div>
                          <div>
                            <div className="text-gray-500 dark:text-gray-400 mb-1">Version</div>
                            <div className="font-bold text-gray-900 dark:text-white">{systemMetadata.version}</div>
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Action Panel */}
                      {!isFinalized ? (
                        <div className="flex items-center justify-between p-6 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/10 dark:to-orange-900/10 border-2 border-yellow-200 dark:border-yellow-800 rounded-xl">
                          <div className="flex items-center space-x-3">
                            <AlertCircle className="w-6 h-6 text-yellow-600 dark:text-yellow-400" />
                            <div>
                              <h4 className="font-bold text-gray-900 dark:text-white">Ready to Finalize?</h4>
                              <p className="text-sm text-gray-600 dark:text-gray-400">
                                Review all sections and finalize your application profile
                              </p>
                            </div>
                          </div>
                          <button
                            onClick={handleFinalize}
                            className="px-8 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-lg hover:from-green-700 hover:to-emerald-700 font-bold shadow-lg hover:shadow-xl transition-all flex items-center space-x-2"
                          >
                            <CheckCircle className="w-5 h-5" />
                        ...
                        <div className="flex items-center justify-between p-6 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/10 dark:to-emerald-900/10 border-2 border-green-200 dark:border-green-800 rounded-xl">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <h4 className="font-bold text-green-900 dark:text-green-100 text-lg">Profile Finalized</h4>
